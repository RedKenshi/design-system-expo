...
export const Design = ({ setOpenModalF, setOpenModalS }: Props) => {
    ...
    return (
        <View style={{ justifyContent: "space-evenly", ...padding }}>
            ...
            <Panel style={{ alignSelf: "stretch", display: 'flex', flexDirection: "column", gap: PALETTE.spacing.m }}>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Thin' }}>Axiforma Thin</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Light' }}>Axiforma Light</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Book' }}>Axiforma Book</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma' }}>Axiforma</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Medium' }}>Axiforma Medium</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-SemiBold' }}>Axiforma SemiBold</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Bold' }}>Axiforma Bold</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-ExtraBold' }}>Axiforma ExtraBold</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Black' }}>Axiforma Black</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Heavy' }}>Axiforma Heavy</Text>
            ...
            <Panel style={{ alignSelf: "stretch", display: 'flex', flexDirection: "column", gap: PALETTE.spacing.m }}>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Thin-Italic' }}>Axiforma Thin Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Light-Italic' }}>Axiforma Light Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Book-Italic' }}>Axiforma Book Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Italic' }}>Axiforma Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Medium-Italic' }}>Axiforma Medium Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-SemiBold-Italic' }}>Axiforma SemiBold Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Bold-Italic' }}>Axiforma Bold Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-ExtraBold-Italic' }}>Axiforma ExtraBold Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Black-Italic' }}>Axiforma Black Italic</Text>
                <Text style={{ color: PALETTE.textOnSurface, textAlign: "left", fontSize: 24, fontFamily: 'Axiforma-Heavy-Italic' }}>Axiforma Heavy Italic</Text>
